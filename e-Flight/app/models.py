...
if __name__ == "__main__":
    with app.app_context():
        ...
        u = User(firstname='jhon', lastname='eban', username='admin',
                 password=str(hashlib.md5('123'.encode('utf-8')).hexdigest()), gender='Male', email='yjhoneban@gmail.com', phone_number='0386764202',
